...
const phases = [
  ...
  },
  {
    ...
    desc: 'Покупатель выбирает устройство. Вы называете цену с комиссией 3% — клиент соглашается.',
    details: ['Хочет купить устройство', 'Партнёр называет цену с комиссией 3%', 'Клиент соглашается'],
    color: 'bg-primary',
  },
  {
    id: 'order',
          ...
          <div className="mt-10 bg-bg-hero rounded-3xl p-8 sm:p-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { label: 'Комиссия — 3%', sub: 'Без скрытых платежей' },
