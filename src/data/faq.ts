...
export const faqData: FaqItem[] = [
  ...
  { q: 'Сколько занимает доставка?', a: 'Выкупленный товар передаётся карго-компании партнёра — перевозку и таможенное оформление выполняет она. Типичный срок — 5–7 рабочих дней с момента выкупа, на тарифе Pro — 3–5 дней за счёт приоритетной обработки заказа.' },
